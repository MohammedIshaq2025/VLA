...
V3-K15-ITER150: Attack applied AFTER center crop (ABLATION: kappa=15, 150 iterations)
...
if __name__ == "__main__":
    ...
    attack_configs = {
        ...
        'full': {'enabled': True, 'freq_ratio': 1.0, 'epsilon': 16/255, 'alpha': 2/255, 'num_iterations': 150, 'kappa': 15.0},
        'low': {'enabled': True, 'freq_ratio': 0.25, 'epsilon': 16/255, 'alpha': 2/255, 'num_iterations': 150, 'kappa': 15.0},
        'mid': {'enabled': True, 'freq_ratio': 0.5, 'epsilon': 16/255, 'alpha': 2/255, 'num_iterations': 150, 'kappa': 15.0},
        'high': {'enabled': True, 'freq_ratio': -0.25, 'epsilon': 16/255, 'alpha': 2/255, 'num_iterations': 150, 'kappa': 15.0},  # Negative for high-pass
    }
